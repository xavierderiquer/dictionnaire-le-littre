...
#ifndef CLASSESURLIGNEUR_H
#define CLASSESURLIGNEUR_H
...
class classeSurligneur : public QSyntaxHighlighter
{
public:
	classeSurligneur(QTextEdit *parent, classePrincipale *fenetre);
private:
