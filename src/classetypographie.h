...
#ifndef CLASSETYPOGRAPHIE_H
#define CLASSETYPOGRAPHIE_H

#include <QDialog>

#include "ui_classetypographie.h"

class classeTypographie : public QDialog, public Ui::fenetreTypographie
{
	Q_OBJECT
public:
	classeTypographie(bool boolModeAccessible, QWidget *parent = 0, Qt::WindowFlags f = 0);
	static QString FeuilleVersCSS(QString texteFeuille);
	static QString FeuilleParDefaut();
private:
	static void RemplacerMotEntier(QString &texte,
