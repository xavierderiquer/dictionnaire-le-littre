...
#ifndef CLASSEFLEXION_H
#define CLASSEFLEXION_H

#include <QDialog>
#include "ui_classeflexion.h"

class classeFlexion : public QDialog, public Ui::fenetreFlexion
{
	Q_OBJECT
public:
	classeFlexion(bool boolModeAccessible, QWidget *parent = 0, Qt::WindowFlags f = 0);
