...
#ifndef CLASSENAVIGATION_H
#define CLASSENAVIGATION_H

#include <QDialog>
#include <QObject>
#include "ui_classenavigation.h"

class classeNavigation : public QDialog, public Ui::fenetreNavigation
{
	Q_OBJECT
public:
	classeNavigation(bool boolModeAccessible, QWidget *parent = 0, Qt::WindowFlags f = 0);

	int nombreEntreeChoisie;
private slots:
	void Consulter();
