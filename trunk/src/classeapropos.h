...
#ifndef CLASSEAPROPOS_H
#define CLASSEAPROPOS_H

#include <QDialog>
#include "ui_classeapropos.h"

class classeAPropos : public QDialog, public Ui::fenetreAPropos
{
	Q_OBJECT
public:
	classeAPropos(bool boolModeAccessible, QWidget *parent = 0, Qt::WindowFlags f = 0);
};
