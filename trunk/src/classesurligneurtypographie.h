...
#ifndef CLASSESURLIGNEURTYPOGRAPHIE_H
#define CLASSESURLIGNEURTYPOGRAPHIE_H

#include <QSyntaxHighlighter>

class classeSurligneurTypographie : public QSyntaxHighlighter
{
public:
	classeSurligneurTypographie(QTextDocument *parent);
private:
	void SurlignerMotsClefs(const QString &texte, const QStringList &listeMotsClefs,
			const QTextCharFormat &formatTexte);
protected:
