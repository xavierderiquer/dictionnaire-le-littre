...
#ifndef CLASSERESULTATSRECHERCHE_H
#define CLASSERESULTATSRECHERCHE_H
...
const int nombreHauteurTitre = 24;
const int nombreHauteurEntree = 84;

class classeResultatsRecherche : public QStyledItemDelegate
{
public:
	classeResultatsRecherche(QObject *parent, QHash<int, structureEntree> *table);
...
#endif // CLASSERESULTATSRECHERCHE_H
